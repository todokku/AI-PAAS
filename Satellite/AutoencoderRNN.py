...
class RnnAutoencoder:
    ...
    def _LSTM_init(self):
        ...
        self.auto_encoder = tf.keras.Sequential(tf.keras.layers.Masking(mask_value=0.0,
    ...
    def train(self, input_val):

        self.auto_encoder.fit(input_val, input_val, epochs=self.epochs)
